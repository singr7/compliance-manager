...
<div class="row">
                        <div class="col-md-8 ">
                            ...
                            <div class="portlet light bordered">
                                <h3>Edit <?php echo $service_name->service_name;?> Project(Testing)</h3>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="customer_id" name="customer_id" onchange="get_process()">
                                                    ...
                                                    <option value="<?php echo $customer->id;?>" <?php if($project_details->customer_id == $customer->id){ echo "Selected";};?>><?php echo $customer->full_name;?></option>
                                                    <?php } ?>
                                                  </select>
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="processid" name="process_id">
                                                    <option value="<?php echo $project_details->process_id;?>" ><?php echo $project_details->ProcessName;?></option> 
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="qsa" name="qsa_id">
                                                   ...
                                                   <?php foreach($qsa_list as $qsa){ ?>
                                                    <option value="<?php echo $qsa->id;?>" <?php if($project_details->qsa_id == $qsa->id){ echo "Selected";};?>><?php echo $qsa->full_name;?></option>
                                                    <?php } ?>
                                                  </select>
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="consultants" name="consultant_id">
                                                    ...
                                                    <option value="<?php echo $consultant->id;?>" <?php if($project_details->consultant_id == $consultant->id){ echo "Selected";};?>><?php echo $consultant->full_name;?></option>
                                                    <?php } ?>
                                                  </select>
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="qa" name="qa_id">
                                                   ...
                                                   <?php foreach($qa_list as $qa){ ?>
                                                    <option value="<?php echo $qa->id;?>"  <?php if($project_details->qa_id == $qa->id){ echo "Selected";};?>><?php echo $qa->full_name;?></option>
                                                    <?php } ?>
                                                  </select>
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                <input type="text" class="form-control remove_first_space" id="star_date" name="start_date" value="<?php echo $project_details->start_date;?>" placeholder="Enter start date" readonly="true" >
...
<script>
    $('.cancel-button').on('click', function() {
                url = '<?php echo base_url(); ?>admin/testing/testing_list?id=<?php echo ID_encode($service_name->id);?>';	
                location = url;
        });
