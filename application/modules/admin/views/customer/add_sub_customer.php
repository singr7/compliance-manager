...
<style>
 ...
 .mbl_select{
    ...
    .select_process_div  .btn-group{
        width:50%;
    }
    .select_process_div .btn-group button{
        width:100%;
    }
    .select_process_div  .btn-group ul{
        width:100%;
    }
</style>
<div class="row">
        ...
        <div class="portlet light bordered grid">
            ...
            <div class="portlet-body form">
                <form role="form" action="" method="POST" id="customer" enctype="multipart/form-data" >
                    <div class="form-body">
                        <div class="col-md-6 ">
                            <input type="hidden" name="parent_id" value="<?php echo id_encode($customer_id);?>">
                        ...
                        <div class="form-group form-md-line-input has-success">
                            ...
                            <div class="form-group form-md-line-input has-info  select_process_div">
                                <select class="form-control" id="processselect" name="process_id[]" multiple>
                                    ...
                                    <?php if (isset($process) && !empty($process)) { ?>
                                        ...
                                        <?php foreach ($process as $customerprocess) { ?>
                                            <option value="<?php echo $customerprocess->id; ?>"><?php echo $customerprocess->process_name; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
