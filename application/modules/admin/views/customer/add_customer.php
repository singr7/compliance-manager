        ...
        <div class="portlet light bordered grid">
                ...
                <form role="form" action="" method="POST" id="customer" enctype="multipart/form-data" >
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input has-success">
                            <input type="text" class="form-control remove_first_space" id="fullname" name="full_name" placeholder="Enter Name">
                        ...
                        <div class="form-group form-md-line-input has-success">
                            <input type="text" class="form-control remove_first_space" id="email" name="email" placeholder="Enter Email Id">
                            <label for="email">Email Id&nbsp;<span style='color:red;'>*</span></label>
                            <label id="email-error" class="error" for="email" style="margin-top: 56px; color:#c8202d"></label>
                        </div>
                            
                        <div class="form-group form-md-line-input has-success">
                            <input type="text" class="form-control codedecimalnumeric2 remove_first_space" id="phoneno" name="phone_number" minlength="7" maxlength="15" placeholder="Enter phone number">
                        ...
                        <div class="form-group form-md-line-input has-success">
                          ...
                          <div class="form-group form-md-line-input has-success">
                            <input type="text" class="form-control codedecimalnumeric2 remove_first_space" id="form_control_4" name="company_number" minlength="7" maxlength="15" placeholder="Enter company contact number">
                        ...
                        <div class="form-group form-md-line-input has-success">
                            <input type="text" class="form-control" id="unquieid" name="unique_id" value="<?php echo time();?>" placeholder="Enter unqiue id" readonly="true">
                            ...
                            <table class="table table-bordered" id="myTable">
                                            ...
                                            <tbody class="dumy_cont">
                                                   <tr class="st_tr">
                                                    ...
                                                    <td> <input type="text" class="form-control form-filter input-sm remove_first_space" id="moreprocess" name="customer_process[]"> </td>
                                                    </tr>
			...
			<div class="col-md-12">
                        <div class="form-actions  noborder" style="text-align: center">
                            <button type="submit" name="submitForm" value="save" class="btn blue" style="    margin: 5px;">Save</button>
                            
                            <button type="button" class="btn default cancel-button" style="margin: 5px;">Cancel</button>
                        </div>
                    </div>
...
<script type="text/javascript">
	...
	$("#my_click").click(function(){
            var addmore = $("#moreprocess").val();
            var rowCount = $('#myTable tr').length;
            
            if(addmore == ''){
             alert('Plaese add process name first');
            }else{
		
               $(".dumy_cont tr:last-child").after('<tr class="hahahah" id="rem'+rowCount+'"><td style="display:none"><input type="hidden" class="form-control form-filter input-sm" name="varient_name[]"></td><td><input type="text" class="form-control form-filter input-sm" name="customer_process[]" id="processnew'+rowCount+'"></td><td><a href="javascript:;" class="btn blue" onClick="remove('+rowCount+')">Remove</a></td></tr>');
           }
