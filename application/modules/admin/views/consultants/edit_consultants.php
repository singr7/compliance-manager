                                    ...
                                    <form role="form" action="" method="POST" id="editqsa">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                <input type="text" class="form-control remove_first_space" id="form_control_1" name="full_name" value="<?php if(!empty($consultant_detail->full_name)){ echo $consultant_detail->full_name;}?>" placeholder="Enter name">
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                <input type="text" class="form-control remove_first_space" id="email" name="email" value="<?php if(!empty($consultant_detail->email)){ echo $consultant_detail->email;}?>" placeholder="Enter email" >
                                            ...
                                            <div class="form-group form-md-line-input has-success mbl_input">
                                                <input type="text" class="form-control codedecimalnumeric2 remove_first_space" id="phonenumber" value="<?php if(!empty($consultant_detail->phone_number)){ echo $consultant_detail->phone_number;}?>" name="phone_number" minlength="7" maxlength="15" placeholder="Enter  phone number">
                                            ...
                                            <div class="form-group form-md-line-input has-success mbl_input">
                                                <input type="text" class="form-control  remove_first_space" id="companyname" name="company_name" value="<?php if(!empty($consultant_detail->company_name)){ echo $consultant_detail->company_name;}?>" placeholder="Enter  company name">
                                            ...
                                            <div class="form-group form-md-line-input has-success mbl_input">
                                                <input type="text" class="form-control codedecimalnumeric2 remove_first_space" id="companynumber" value="<?php if(!empty($consultant_detail->company_number)){ echo $consultant_detail->company_number;}?>" name="company_number" minlength="7" maxlength="15" placeholder="Enter  company contact number">
                                            ...
                                            <div class="form-group form-md-line-input has-success mbl_input">
                                                <textarea class="form-control remove_first_space" id="address" name="address"   placeholder="Enter  address"><?php if(!empty($consultant_detail->address)){ echo $consultant_detail->address;}?></textarea>
                                            ...
                                            <div class="form-group form-md-line-input has-info">
                                                <select class="form-control remove_first_space" id="form_control_9" name="status">
                                                    ...
                                                    <option value="active" <?php if($consultant_detail->status == 'active'){ echo "selected";}?>>Active</option>
                                                    <option value="inactive" <?php if($consultant_detail->status == 'inactive'){ echo "selected";}?>>Inactive</option>
                                                  </select>
