                            ...
                            <div class="portlet light bordered no-padding">
                                ...
                                <div class="portlet-body form">
                                   ...
                                   <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                <input type="password" class="form-control" id="password" name="new_password"  placeholder="New Password" style="margin-top:20px;">
                                                <label for="form_control_1">New Password &nbsp;<span style='color:red;'>*</span></label>
                                                <label id="password-error" class="error" for="password" style="margin-top: 60px; color:#c8202d"></label>
