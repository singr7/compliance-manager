...
<html lang="en">
    ...
    <!--                    <span class="form-title">Welcome.</span>-->
                ...
                <div class="create-account">
                    <p>
                        <a href="javascript:;"  id="register-btn">Click here to install certificate</a>
                    </p>
                </div>  
                <div class="form-actions">
                    <div class="pull-left">
        ...
        <div class="copyright hide"> <?= date('Y'); ?> ï¿½ Panacea. </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script>
            ...
            function forgot() {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>auth/auth/forgot",
                    type: "POST",
                    data: {email: email},
