...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
			...
			<div class="portlet-title">
                <div class="btn-group">
                    <span class="caption-subject">Customer Name: <?php echo $customer_info->full_name;?> </span>
                </div>
                <div class="actions">
                        <div class="btn-group">
            ...
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject"><?php echo $customer->process_name;?></span>
                </div>
            </div>
								...
								<tr class="odd gradeX">
                                   <?php $servicename = _get_service_name($testing_service_process->testing_id);?>
									...
									<!-- <a href="<?= base_url();?>qa/qa_view?id=<?php echo ID_encode($project->id);?>&&service_id=<?php echo ID_encode($service_name->id);?>&&cus_id=<?php echo ID_encode($project->customer_id);?>&&process_id=<?php echo ID_encode($project->process_id);?>&&qsa_id=<?php echo ID_encode($project->qsa_id);?>&&qa_id=<?php echo ID_encode($project->qa_id);?>&&consultant_id=<?php echo ID_encode($project->consultant_id);?>" class="label label-sm btn-default label-info margin-right-10 tooltips" data-lang="16"  data-container="body" data-placement="top" title="View" data-original-title="Status">
									 ...
									 <a href="<?php echo  base_url();?>qa/qa_view?process_id=<?php echo ID_encode($testing_service_process->process_id);?>&&service_id=<?php echo ID_encode($testing_service_process->testing_id);?>">View</a></td>
