                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
								...
								echo date("d-m-Y", strtotime($customer_service_process->end_date));
                                     ...
                                     <td class="center"><a href="<?= base_url();?>consultant/consultant_view?process_id=<?php echo ID_encode($customer_service_process->process_id);?>&service_id=<?php echo ID_encode($customer_service_process->service_id);?>">View</a></td>
                        ...
                        <tr class="odd gradeX">
                                   ...
                                   <?php $servicename = _get_service_name($testing_service_process->testing_id);?>
                                    ...
                                    <td class="center"><?php echo date("d-m-Y", strtotime($testing_service_process->start_date));?></td>
                                     ...
                                     <td class="center"><a href="<?= base_url();?>consultant/consultant_view?process_id=<?php echo ID_encode($testing_service_process->process_id);?>&service_id=<?php echo ID_encode($testing_service_process->testing_id);?>">View</a></td>
