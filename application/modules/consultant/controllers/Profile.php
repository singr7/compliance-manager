...
class Profile extends CI_Controller {
    ...
    public function index() {
        ...
        if (isPostBack()) {
            ...
            $data['breadcum'] = array("consultant/dashboard/" => "Home", '' => "My Profile");
...
//                setcookie('kc_email','',time()+(86400 * 30),"/");
                ...
                redirect('consultant/profile/reset_password');
            } else {
            ...
            $data['result'] = '';
            $data['breadcum'] = array("consultant/dashboard/" => "Home", '' => "Reset Password");
