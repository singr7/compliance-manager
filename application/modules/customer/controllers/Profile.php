    ...
    public function index() {
        ...
        if (isPostBack()) {
            ...
            if ($rs_data['status'] == "success") {
                ...
                $userdata->first_name = $this->input->post('first_name', NULL);
                $userdata->last_name = $this->input->post('last_name', NULL);
                $userdata->mobile_number = $this->input->post('country_code').'-'.$this->input->post('mobile_number',NULL);
            ...
            $data['country_phone_code'] = $this->Profile_mod->country_phone_code();
            $data['result'] = ($result['status'] == "success") ? $result['result'] : '';
            $data['breadcum'] = array("customer/dashboard/" => "Home", '' => "My Profile");
...
//                setcookie('kc_email','',time()+(86400 * 30),"/");
                ...
                redirect('customer/profile/reset_password');
            } else {
            ...
            $data['result'] = '';
            $data['breadcum'] = array("customer/dashboard/" => "Home", '' => "Reset Password");
